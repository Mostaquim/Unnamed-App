...
var _geojson = __webpack_require__(328);

var _geojson2 = _interopRequireDefault(_geojson);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var map = L.map('map').setView([-16.9252, 145.7670], 13);
var lang = ['English', 'German', 'Spanish'];
var currentLang = 'en';
...
var myIcon = L.icon({
    iconUrl: './img/down-under-drive.png',
    iconSize: [65, 50],
    iconAnchor: [0, 0]
});
...
function clickfeature(e) {
    ...
    $('#featureName').html(e.target.feature.properties.Name);
    $("#modal_image").attr('src', e.target.feature.properties.Imageurl);
}
...
info.onAdd = function (map) {
    ...
    var addbutton = L.DomUtil.create('button', 'btn btn-primary');
    addbutton.appendChild(document.createTextNode("Add Points"));
    addbutton.id = "addBtn";
    this._div.appendChild(addbutton);
...
// adding new feature
var zzz = { "type": "FeatureCollection",
    "features": [{ "type": "Feature",
        "geometry": { "type": "Point", "coordinates": [145.7670, -16.9252] },
        "properties": {
            "Name": 'Demo',
...
L.geoJSON(zzz, { onEachFeature: onEachFeature }).addTo(map);
var z = 0;
var ltlng;
...
function addMarker(e) {
    ...
    if (z === 1) {
        // remove x later
        x += 1;
        // create new feature in geojson zzz
        newFeature(e.latlng);
    }
}

function newFeature(latlng) {

    $('#setting').modal('show');
    $('#settingbutton').on('click', function () {
        var name = $('#markername').val();
        var imageurl = $('#markerimage').val();
...
document.getElementById('addBtn').onclick = function (e) {
    ...
    z = 1;
    var clickz = map.addEventListener('click', addMarker);
};
...
var mapdata = { "type": "FeatureCollection",
    "features": [{ "type": "Feature",
        "geometry": { "type": "Point", "coordinates": [145.7670, -16.9252] },
        "properties": {
            "Company": "Down Under Dive",
            "image": "down-under-drive.jpg",
            "Descriptonen": "EVOLUTION departs Cairns daily offering a fast, comfortable and affordable cruise, with five hours spent visiting two spectacular Outer Great Barrier Reef destinations. This large modern vessel provides a superior ride in all weather conditions, no big crowds and exclusive protected Reef locations. Professional, friendly and attentive staff ensure a safe and enjoyable fun filled experience.",
            "videourl": 'y2r1VoZwV1w'
